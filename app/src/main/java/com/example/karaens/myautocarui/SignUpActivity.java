...
public class SignUpActivity extends AppCompatActivity {
    ...
    int gCode,flag;
    String carID,pWord,email;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sign_up);
        sName = findViewById(R.id.sCarID);
        ...
        buttonSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (gCode == 0) {
                    Log.d("tag1","t0.5");
                    mAuth.createUserWithEmailAndPassword(email, pWord).addOnCompleteListener(SignUpActivity.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                User user=new User(carID,email,firebaseUser.getUid());
